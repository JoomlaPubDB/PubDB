 ...
 * @since  1.6
 */
class PubdbControllerPeriodicals extends \Joomla\CMS\MVC\Controller\AdminController
{
	/**
	 * Method to clone existing Periodicals
	 *
	 * @return void
     *
     * @throws Exception
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'periodical', $prefix = 'PubdbModel', $config = array())
	{
