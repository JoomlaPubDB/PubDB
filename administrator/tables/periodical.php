 ...
 * @since  1.6
 */
class PubdbTableperiodical extends \Joomla\CMS\Table\Table
{
	/**
	...
	public function check()
	{
		...
		// Check if issn is unique
		if (!$this->isUnique('issn'))
		{
			throw new Exception('Your <b>issn</b> item "<b>' . $this->issn . '</b>" already exists');
		}
