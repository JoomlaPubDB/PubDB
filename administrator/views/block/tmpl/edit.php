...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="block-form" class="form-validate form-horizontal">
	...
	<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'block')); ?>
	<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'block', JText::_('COM_PUBDB_TAB_BLOCK', true)); ?>
	<div class="row-fluid">
		<div class="span10 form-horizontal">
			<fieldset class="adminform">
				...
				<?php echo $this->form->renderField('suffix'); ?>
