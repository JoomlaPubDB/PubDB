 ...
 * @since  1.6
 */
class PubdbViewBlock extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(Text::_('COM_PUBDB_TITLE_BLOCK'), 'block.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_pubdb.block', $this->item->id);
		}
