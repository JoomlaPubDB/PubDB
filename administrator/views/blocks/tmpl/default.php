...
if ($saveOrder) {
  $saveOrderingUrl = 'index.php?option=com_pubdb&task=blocks.saveOrderAjax&tmpl=component';
  HTMLHelper::_('sortablelist.sortable', 'blockList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}

$sortFields = $this->getSortFields();
?>

<form action="<?php echo Route::_('index.php?option=com_pubdb&view=blocks'); ?>" method="post"
      ...
      <?php else : ?>
        <div id="j-main-container">
          ...
          <?php echo LayoutHelper::render('joomla.searchtools.default', array('view' => $this)); ?>
            ...
            <table class="table table-striped" id="blockList">
                <thead>
                <tr>
