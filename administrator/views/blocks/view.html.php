 ...
 * @since  1.6
 */
class PubdbViewBlocks extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(Text::_('COM_PUBDB_TITLE_BLOCKS'), 'blocks.png');

		// Check if the form exists before showing the add/edit buttons
		$formPath = JPATH_COMPONENT_ADMINISTRATOR . '/views/block';
		...
		JHtmlSidebar::setAction('index.php?option=com_pubdb&view=blocks');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`prefix`' => JText::_('COM_PUBDB_BLOCKS_PREFIX'),
			'a.`name`' => JText::_('COM_PUBDB_BLOCKS_NAME'),
			'a.`suffix`' => JText::_('COM_PUBDB_BLOCKS_SUFFIX'),
		);
	}
