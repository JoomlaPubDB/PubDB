...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=PubDB&task=literatures.saveOrderAjax&tmpl=component';
...
<form action="<?php echo Route::_('index.php?option=PubDB&view=literatures'); ?>" method="post"
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="literatureList">
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=PubDB&task=literature.edit&id='.(int) $item->id); ?>">
