...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_pubdb&task=people.saveOrderAjax&tmpl=component';
...
<form action="<?php echo Route::_('index.php?option=com_pubdb&view=people'); ?>" method="post"
			...
			<table class="table table-striped" id="personList">
				...
				<tr>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_PUBDB_PEOPLE_ID', 'a.`id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_PUBDB_PEOPLE_FIRST_NAME', 'a.`first_name`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_PUBDB_PEOPLE_LAST_NAME', 'a.`last_name`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_PUBDB_PEOPLE_MIDDLE_NAME', 'a.`middle_name`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_PUBDB_PEOPLE_SEX', 'a.`sex`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_PUBDB_PEOPLE_TITLE', 'a.`title`', $listDirn, $listOrder); ?>
				</th>
