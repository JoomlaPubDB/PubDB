...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="person-form" class="form-validate form-horizontal">
	...
	<div class="row-fluid">
		<div class="span10 form-horizontal">
			<fieldset class="adminform">
				<legend><?php echo JText::_('COM_PUBDB_FIELDSET_PERSON'); ?></legend>
				<?php echo $this->form->renderField('first_name'); ?>
				<?php echo $this->form->renderField('last_name'); ?>
				<?php echo $this->form->renderField('middle_name'); ?>
