...
if ($saveOrder) {
  $saveOrderingUrl = 'index.php?option=com_pubdb&task=referencetypes.saveOrderAjax&tmpl=component';
  HTMLHelper::_('sortablelist.sortable', 'referencetypeList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}

$sortFields = $this->getSortFields();
?>

<form action="<?php echo Route::_('index.php?option=com_pubdb&view=referencetypes'); ?>" method="post"
      ...
      <?php else : ?>
        <div id="j-main-container">
          ...
          <?php echo LayoutHelper::render('joomla.searchtools.default', array('view' => $this)); ?>
            ...
            <table class="table table-striped" id="referencetypeList">
                <thead>
                <tr>
                  ...
                  <?php endif; ?>
                    ...
                    <th class='left'>
                      <?php echo JHtml::_('searchtools.sort', 'COM_PUBDB_REFERENCETYPES_NAME', 'a.`name`', $listDirn, $listOrder); ?>
                    </th>
                    <th class='left'>
                ...
                <?php foreach ($this->items as $i => $item) :
                  ...
                  ?>
                    <tr class="row<?php echo $i % 2; ?>">
                      ...
                      <?php if (isset($this->items[0]->state)): ?>
                          <td class="center">
                            <?php echo JHtml::_('jgrid.published', $item->state, $i, 'referencetypes.', $canChange, 'cb'); ?>
                          </td>
                      <?php endif; ?>
