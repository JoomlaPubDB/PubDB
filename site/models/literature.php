...
class PubdbModelLiterature extends \Joomla\CMS\MVC\Model\ItemModel
{
	...
	public function getItem($id = null)
	{
		...
		if (isset($this->_item->periodical_id) && $this->_item->periodical_id != '')
		{
			...
			$this->_item->periodical_id = !empty($textValue) ? implode(', ', $textValue) : $this->_item->periodical_id;
		...
		if (isset($this->_item->series_title_id) && $this->_item->series_title_id != '')
		{
			...
			$this->_item->series_title_id = !empty($textValue) ? implode(', ', $textValue) : $this->_item->series_title_id;
		...
		if (isset($this->_item->authors) && $this->_item->authors != '')
		{
			...
			$this->_item->authors = !empty($textValue) ? implode(', ', $textValue) : $this->_item->authors;
		...
		if (isset($this->_item->translators) && $this->_item->translators != '')
		{
			...
			$this->_item->translators = !empty($textValue) ? implode(', ', $textValue) : $this->_item->translators;
		...
		if (isset($this->_item->others_involved) && $this->_item->others_involved != '')
		{
			...
			$this->_item->others_involved = !empty($textValue) ? implode(', ', $textValue) : $this->_item->others_involved;
		...
		if (isset($this->_item->publishers) && $this->_item->publishers != '')
		{
			...
			$this->_item->publishers = !empty($textValue) ? implode(', ', $textValue) : $this->_item->publishers;
