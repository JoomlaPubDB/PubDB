 ...
 * @since  1.6
 */
class PubdbModelPeriodical extends \Joomla\CMS\MVC\Model\ItemModel
{
    public $_item;
	...
	protected function populateState()
	{
		...
		{
			$this->setState('periodical.id', $params_array['item_id']);
		}
	...
	public function getItem($id = null)
	{
            if ($this->_item === null)
            {
                ...
                if (empty($id))
                {
                    $id = $this->getState('periodical.id');
                }
	...
	public function getItemIdByAlias($alias)
	{
            ...
            $result     = null;
            $aliasKey   = $this->getAliasFieldNameByView('periodical');
	...
	{
		// Get the id.
		$id = (!empty($id)) ? $id : (int) $this->getState('periodical.id');
