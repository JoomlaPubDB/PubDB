 ...
 * @since  1.6
 */
class PubdbModelPerson extends \Joomla\CMS\MVC\Model\ItemModel
{
    public $_item;
	...
	protected function populateState()
	{
		...
		{
			$id = Factory::getApplication()->getUserState('com_pubdb.edit.person.id');
		}
		else
		{
			$id = Factory::getApplication()->input->get('id');
			Factory::getApplication()->setUserState('com_pubdb.edit.person.id', $id);
		}
	...
	public function getItemIdByAlias($alias)
	{
            ...
            $result     = null;
            $aliasKey   = $this->getAliasFieldNameByView('person');
