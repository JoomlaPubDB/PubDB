...
<div class="item_fields">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td><?php if( in_array($this->item->reference_type, [1,2,3,4,5,6,7,8,9]) ) echo $this->item->doi; ?></td>
        </tr>

        <tr>
            <th><?php echo JText::_('COM_PUBDB_FORM_LBL_LITERATURE_ISBN'); ?></th>
            <td><?php if( in_array($this->item->reference_type , [ 1,3,4,5]) ) echo $this->item->isbn; ?></td>
        </tr>
        ...
        <tr>
            ...
            <td><?php if( in_array($this->item->reference_type , [ 3,4,5,8,9]) ) echo $this->item->page_count; ?></td>
        </tr>

        <tr>
            <th><?php echo JText::_('COM_PUBDB_FORM_LBL_LITERATURE_PAGE_RANGE'); ?></th>
            <td><?php if( in_array($this->item->reference_type , [ 1,3,4,5,8,9]) ) echo $this->item->page_range; ?></td>
        </tr>

        <tr>
            <th><?php echo JText::_('COM_PUBDB_FORM_LBL_LITERATURE_PERIODICAL_ID'); ?></th>
            <td><?php if( in_array($this->item->reference_type , [ 3,5,7,8]) ) echo $this->item->periodical_id; ?></td>
        </tr>
        ...
        <tr>
            ...
            <td><?php if( in_array($this->item->reference_type , [ 1,3,4,5]) ) echo $this->item->eisbn; ?></td>
        </tr>

        <tr>
            <th><?php echo JText::_('COM_PUBDB_FORM_LBL_LITERATURE_VOLUME'); ?></th>
            <td><?php if( in_array($this->item->reference_type , [ 1,4,5,12]) ) echo $this->item->volume; ?></td>
        </tr>
